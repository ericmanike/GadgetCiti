...
const colClasses: Record<number, string> = {
  ...
  4: 'grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4',
  5: 'grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5',
  6: 'grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6',
};  
