...
import { LogOut, User,Banknote, ChevronDown, ChevronUp, ShoppingBag, Heart } from "lucide-react"
  ...
  if (!user) {
    return (
      <button
        ...
        className="px-4 py-2 md:py-2 bg-orange-500 text-white rounded-lg cursor-pointer text-base md:text-sm font-bold hover:bg-orange-600 transition"
      >
        Sign In
      </button>
    );
