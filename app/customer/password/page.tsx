                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-gray-200 focus:border-[#1e293b] focus:ring-1 focus:ring-[#1e293b] focus:bg-white rounded-xl text-base font-medium transition focus:outline-none placeholder-slate-400"
