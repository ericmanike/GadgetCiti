        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar">
                        {images.map((img, idx) => (
                            <button
                                ...
                                className={`relative w-20 h-20 rounded-xl overflow-hidden border-2 transition-all flex-shrink-0 ${activeImage === idx ? "border-blue-600 ring-2 ring-blue-100 shadow-md scale-105" : "border-transparent bg-white hover:border-gray-200"
                                    }`}
                            >
                                <Image src={img} alt={`${product.name} thumbnail ${idx}`} fill className="object-cover p-1" />
                            </button>
                        ))}
                    </div>
                </div>
                ...
                <div className="lg:col-span-5 flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                            <Link href={`/buy?brand=${product.brand}`} className="text-blue-600 text-sm font-black uppercase tracking-widest hover:underline">
                                {product.brand}
                            </Link>
                    ...
                    <div className="p-6 rounded-3xl bg-white shadow-sm border border-gray-100 flex flex-col gap-4">
                        <div className="flex flex-col">
                            ...
                            <p className="text-xs text-gray-500 mt-1 font-bold">Inclusive of all taxes</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                            <button
                                className="bg-blue-600 hover:bg-blue-700 text-white font-black py-4 px-8 rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-95 shadow-lg shadow-blue-200 disabled:bg-gray-300"
                            ...
                            <button
                                className="bg-white hover:bg-gray-50 text-gray-900 border-2 border-gray-900 font-black py-4 px-8 rounded-2xl transition-all active:scale-95 disabled:border-gray-200 disabled:text-gray-300"
                                disabled={!product.inStock}
                            >
                                BUY NOW
                            </button>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex items-center gap-3 p-4 rounded-2xl bg-blue-50/40 border border-blue-50">
                        ...
                        <div className="flex items-center gap-3 p-4 rounded-2xl bg-orange-50/40 border border-orange-50">
                            <RotateCcw className="text-orange-500" size={24} />
                            <div className="flex flex-col">
                                <span className="text-xs font-black text-gray-900">7 Days Return</span>
                ...
                <div className="lg:col-span-3 flex flex-col gap-6">
                    <div className="p-6 rounded-3xl bg-white shadow-sm border border-gray-100 flex flex-col gap-6">
                        <div>
                            ...
                            <div className="flex flex-col gap-5">
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-[10px] text-gray-500 mt-1">Ready for delivery in 24 hours to Accra</p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    <div className="shrink-0 w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-[10px] text-gray-500 mt-1">Available at over 50 stations near you</p>
                                    </div>
                                </div>
                            </div>
                        </div>
